 ...
 * debug method
 *
 * @param bool $var false
 * @param bool $showHtml false
 * @param bool $showFrom true
 * @return void
 * @access public
 */
	function debug($var = false, $showHtml = false, $showFrom = true) {
		if ($showFrom) {
			...
			echo '<strong>' . substr(str_replace(dirname(dirname(__FILE__)), '', $calledFrom[0]['file']), 1) . '</strong>';
